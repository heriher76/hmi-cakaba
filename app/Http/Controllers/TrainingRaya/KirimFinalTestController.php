...
class KirimFinalTestController extends Controller
{
    public function store(Request $request)
    {
        $list_pertanyaan = DB::table('training_raya_question_test')->where('tipe', 'final')->where('training_raya_kategori_id', $request->training_raya_kategori_id)->get();
        ...
        alert()->success('Berhasil kirim Final Test', '');
        return back();
    }
}
