          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
            	<h1 class="m-0 text-dark">Middle Test {{ $title }}</h1>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                    	<a href="{{ url('/admin/training-raya/middle-test/delete/'.$pertanyaan->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Hapus Pertanyaan ini?')">Hapus</a>
                    </td>
                  </tr>
                  @endforeach
                  </tfoot>
        ...
        <div class="modal fade" id="createQuestionModal" tabindex="-1" role="dialog" aria-labelledby="exampleScreenerLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/admin/training-raya/middle-test') }}" method="POST" id="tambahPertanyaanModal">
                        @csrf
...
<script>
  ...
  $('.detail').click(function() {
        ...
        $.ajax({
            url: "{{ url('/admin/training-raya/middle-test/detail') }}",
            type: "POST",
            data: {
                user_id: id,
                _token: "{{ csrf_token() }}"
