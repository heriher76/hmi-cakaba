          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
            	<h1 class="m-0 text-dark">Materi Screening {{ $title }}</h1>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $user->nama }}</td>
                    <td>
                    	<a href="{{ url('/admin/training-raya/materi-screening/delete/'.$user->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Hapus Materi ini?')">Hapus</a>
                    </td>
                  </tr>
                  @endforeach
                  </tfoot>
        ...
        <div class="modal fade" id="screenerModal" tabindex="-1" role="dialog" aria-labelledby="exampleScreenerLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/admin/training-raya/materi-screening') }}" method="POST" id="formScreenerModal">
                        @csrf
