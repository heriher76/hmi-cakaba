            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>{{ $key+1 }}</td>
                    <td>{{ $komisariat->title }}</td>
                    <td>{{ strip_tags(\Illuminate\Support\Str::limit($komisariat->description, 60, $end='...')) }}</td>
                    <td>{{ $komisariat->url }}</td>
                    <td>{{ $komisariat->image }}</td>
                    <td>
                    	<a href="{{ url('/admin/slider/'.$komisariat->id.'/edit') }}" class="btn btn-success">Edit</a>
                    	<form action="{{ url('admin/slider/'.$komisariat->id) }}" method="POST" style="display: inline;">
                            {{ csrf_field() }}
                            {{ method_field('delete') }}
