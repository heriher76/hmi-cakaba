...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ url('front/assets/img/logo_hmi.jpg') }}" rel="icon">
  <link href="{{ url('front/assets/img/logo_hmi.png') }}" rel="apple-touch-icon">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Tentang</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="about.html">HMI Cakaba</a></li>
              <li><a href="team.html">Visi Misi</a></li>
              <li><a href="testimonials.html">Program Kerja</a></li>
            </ul>
          </li>

          <li class="dropdown"><a href="#"><span>Pelayanan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="">Surat Rekomendasi Training</a></li>
            </ul>
          </li>
